...
T_NOTES_QUIZ, T_OPTIONS, T_QUIT, T_TREBLE_CLEF, T_BASS_CLEF, T_SOUNDS, T_TIMER, T_SOFT_TRANSITIONS, T_LANGUAGE, T_BACK, T_NO, T_YES, T_ENGLISH, T_SPANISH, T_OFF, T_SECONDS, T_5SEC, T_10SEC, T_15SEC, T_20SEC, T_PRESS_KEY, T_TIMEISUP, T_EXPLAIN_SOFT_TRANSITIONS, T_DO, T_RE, T_MI, T_FA, T_SOL, T_LA, T_SI = range(30) 
